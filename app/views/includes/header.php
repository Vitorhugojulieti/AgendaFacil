...
<header class="flex flex-col  gap-4 p-4 border-b-2 border-lightGray">
    <div class="w-full flex justify-between items-center">
        ...
        <div class="lg:flex hidden buttons items-center gap-8">
            <div class="flex items-center gap-2 relative">
                <div id="btnOpenPopUpNotification" class="p-3 flex items-center gap-4 hover:cursor-pointer ">
                    ...
                    <span class="w-6 h-6 rounded-full bg-principal9 text-white text-center" id="displayNotifications"><?php echo isset($unmarkedNotifications) ? $unmarkedNotifications : 0;?></span>
                </div>
      ...
      <!-- menu mobile -->
        <div id="menuMobile" class="hidden bg-principal10 text-white w-3/4 h-screen p-4  flex-col items-start gap-8 absolute top-0 left-0 z-10">
            ...
            <nav class=" flex w-full min-h-full bg-principal10 text-white  flex-col p-4 " >
                <ul class="w-full flex flex-col gap-8 font-Poppins">
                    ...
                    <a href="/admin/login/destroy" class="flex items-center gap-2 hover:cursor-pointer"><i class='bx bx-log-out text-2xl'></i><span class="hover:underline text-xl">Sair</span></a>
                </ul>
            </nav>
        </div>
        <!-- end menu mobile -->
...
<header class="flex flex-col  gap-4 p-4 border-b-2 border-lightGray">
    ...
    <div class="lg:flex hidden w-full  items-center justify-between mt-2 ">
        <button class="location w-2/4 flex gap-1 items-center justify-start " id="btnOpenModalLocation">
