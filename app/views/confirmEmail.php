<body style="overflow:none;">
    <div class="w-full min-h-screen flex flex-col justify-center items-center bg-principal10">
        <form action="" method="post" class="w-2/6 h-5/6 bg-white rounded p-4">
            <div class="w-full h-full flex flex-col gap-6 items-center">
                ...
                <div class="fields w-full flex justify-around items-center">
                    <input type="text" class="field w-1/6 h-12 p-2 border-2 border-borderFormColor text-2xl text-center font-semibold text-principal10 rounded outline-principal10 focus:shadow-lg shadow-black" >
                    <input type="text" class="field w-1/6 h-12 p-2 border-2 border-borderFormColor text-2xl text-center font-semibold text-principal10 rounded outline-principal10 focus:shadow-lg shadow-black" >
                    <input type="text" class="field w-1/6 h-12 p-2 border-2 border-borderFormColor text-2xl text-center font-semibold text-principal10 rounded outline-principal10 focus:shadow-lg shadow-black" >
                    <input type="text" class="field w-1/6 h-12 p-2 border-2 border-borderFormColor text-2xl text-center font-semibold text-principal10 rounded outline-principal10 focus:shadow-lg shadow-black" >
                </div>
                ...
                <div class="w-full flex items-center justify-center gap-4">
                    ...
                    <a href="" class="bg-principal10 text-white font-semibold p-2 pl-4 pr-4 rounded hover:underline">Verificar</a>
                </div>
            </div>
        </form>    
    </div>
