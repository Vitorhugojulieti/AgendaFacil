<main class="flex overflow-x-hidden">
    ...
    <div class="lg:w-5/6 w-full flex lg:absolute flex-col justify-start items-start bg-bgPrincipal p-4 pr-6" style="left:17%; top:10%;">
            ...
            <?php if(count($schedules) !== 0 ){ ?>
                <table class="w-full bg-white shadow shadow-borderFormColor p-2 rounded-lg">
                    <thead class="bg-white p-4  border-b-2 border-lightGray  ">
                        <tr >
                            <th class="font-Urbanist font-semibold text-grayInput text-start p-2">Empresa</th>
                                    ...
                                    <td class="p-2 ">
                                        <div class="flex items-center gap-2">
                                            <div class="w-full flex flex-col">
                                                <h3 class="font-semibold"><?php echo $schedule->getCompany()->getName();?></h3>
                                            </div>
                                        </div>
                                    </td>
    ...
    <script    src="/assets/js/noModuleAgendaClient.js" defer></script>
